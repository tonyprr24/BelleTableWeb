...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <div class="formulaire">
    <form class="login-form" method="POST" action="connexion.php">
      ...
      <input class="buttonco" type="submit" name="connect" value="Connexion">
      <?php
		if (isset($_GET['Acces']))
		{
			$acces = $_GET['Acces'];
			if ($acces == 'Inscris')
			{
				echo "<center><font><b>Bienvenue</b><br />Vous pouvez vous connecter</font></center>";
			}
			if ($acces == 'Incorrect')
			{
				echo "<center><font color='red' size=2px>Le nom d'utilisateur ou le mot de passe est incorrect !</font></center>";
			}
		}
	  ?>
      <p class="messageco">Pas de compte ? <a href="inscription.php"><b> Créer un compte</b></a></p>
    </form>
  </div>
</div>	
			   		</div>
