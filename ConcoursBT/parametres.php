...
<div class="wrapper">
	<div class="header header-filter" style="background-image: url('assets/img/parametres.jpg');">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<h1 class="title text-center">Paramètres</h1>
				</div>
			</div>
		</div>
	</div>
				...
				<form method="POST" action="updating.php">
					...
					<div class="col-sm-3">
						<div class="form-group label-floating">
							...
							<input type="text" class="form-control" value="<?php echo $_SESSION['Nom']; ?>">
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div class="form-group label-floating">
							...
							<input type="email" class="form-control" value="<?php echo $_SESSION['Mail']; ?>">
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div class="form-group label-floating">
							...
							<input type="text" class="form-control" value="<?php echo $_SESSION['Pseudo']; ?>">
						</div>
					</div>
					Importez votre avatar
					<input type="file" class="btn btn-primary" name="avatar" value="Importez votre avatar">
