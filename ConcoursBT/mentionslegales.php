...
<div class="wrapper">
	<div class="header header-filter" style="background-image: url('assets/img/mentionslegales.jpg');">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<h1 class="title text-center">Mentions légales</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="main main-raised">
	    ...
	    <div class="container">
				<div class="row tim-row">
	                <h2 class="text-center">1. Présentation du site :</h2>
	                <legend></legend>
	                <div class="col-md-8 col-md-offset-2">
                    <br />
                    Conformément aux dispositions des articles 6-III et 19 de la Loi n° 2004-575 du 21 juin 2004 pour la Confiance dans l'économie numérique, dite L.C.E.N., nous portons à la connaissance des utilisateurs et visiteurs du site : <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> les informations suivantes :</p>
                    ...
                    Nom de la Société :<strong> Belle Table</strong><br />
                    Adresse : <strong>20 rue de la gare 75100 Paris 75100 PARIS</strong><br />
                    Tél  : <strong>01 75 02 77 14</strong><br />
                    Au Capital de :<strong> 100 000? €</strong><br />
                    SIRET :  <strong>732 829 320 00074   </strong>R.C.S. :<strong> PARIS 654 987 321</strong><br />
                    Numéro TVA intracommunautaire : <strong>FR44732829320</strong><br />
        ...
        <div class="row tim-row">
                  <div class="col-md-8 col-md-offset-2">
                    <h2 class="text-center">2. Description des services fournis :</h2>
  	                <legend></legend>

                    <br />
                    Le site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> a pour objet de fournir une information concernant l’ensemble des activités de la société.<br />
                    Le proprietaire du site s’efforce de fournir sur le site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> des informations aussi précises que possible. Toutefois, il ne pourra être tenue responsable des omissions, des inexactitudes et des carences dans la mise à jour, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces informations.<br />
                    Tous les informations proposées sur le site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> sont données à titre indicatif, sont non exhaustives, et sont susceptibles d’évoluer. Elles sont données sous réserve de modifications ayant été apportées depuis leur mise en ligne.<br />
                     </p>
                   </div>
                 </div>
                 <div class="row tim-row">
                           <div class="col-md-8 col-md-offset-2">
                             <h2 class="text-center">3. Propriété intellectuelle et contrefaçons :</h2>
                 ...
                 <div class="row tim-row">
                           <div class="col-md-8 col-md-offset-2">
                             <h2 class="text-center">4. Liens hypertextes et cookies :</h2>
                    <br />
                    Le site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> contient un certain nombre de liens hypertextes vers d’autres sites (partenaires, informations …) mis en place avec l’autorisation de le proprietaire du site . Cependant, le proprietaire du site n’a pas la possibilité de vérifier le contenu des sites ainsi visités  et décline donc toute responsabilité de ce fait quand aux risques éventuels de contenus illicites.<br />
                    <br />
                    L’utilisateur est informé que lors de ses visites sur le site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a>, un ou des cookies sont susceptible de s’installer automatiquement sur son ordinateur. Un cookie est un fichier de petite taille, qui ne permet pas l’identification de l’utilisateur, mais qui enregistre des informations relatives à la navigation d’un ordinateur sur un site. Les données ainsi obtenues visent à faciliter la navigation ultérieure sur le site, et ont également vocation à permettre diverses mesures de fréquentation.<br />
                    <br />
                 ...
                 <div class="row tim-row">
                           <div class="col-md-8 col-md-offset-2">
                             <h2 class="text-center">5. Protection des biens et des personnes - gestion des données personnelles :</h2>
                    <br />
                    Utilisateur : Internaute se connectant, utilisant le site susnommé : <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a><br />
                    ...
                    <p style="text-align:justify">Sur le site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a>, le proprietaire du site ne collecte des informations personnelles relatives à l'utilisateur que pour le besoin de certains services proposés par le site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a>. L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> l’obligation ou non de fournir ces informations.<br />
                    Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, tout utilisateur dispose d’un droit d’accès, de rectification, de suppression et d’opposition aux données personnelles le concernant. Pour l’exercer, adressez votre demande à <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> par email : email du webmaster ou  en effectuant sa demande écrite et signée, accompagnée d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la réponse doit être envoyée.</p>

                    <p style="text-align:justify">Aucune information personnelle de l'utilisateur du site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat du site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> à le proprietaire du site et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de l'utilisateur du site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a>.<br />
                    Le site <a href="http://www.belle-table.fr" target="_blank">www.belle-table.fr</a> est déclaré à la CNIL sous le numéro test.</p>
