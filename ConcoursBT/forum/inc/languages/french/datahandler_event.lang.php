...
$l['eventdata_invalid_start_date'] = "La date de début d’évènement que vous avez entrée est invalide. Assurez-vous de spécifier le jour, le mois et l’année et aussi que le jour entré est valide pour ce mois en particulier.";
...
$l['eventdata_cant_specify_one_time'] = "Si vous entrez l’heure de début d’un évènement, vous devez entrer une heure de fin pour cet évènement.";
...
$l['eventdata_only_ranged_events_repeat'] = "Seuls des évènements étendus (évènements avec une date de début et de fin) peuvent être répétés.";
