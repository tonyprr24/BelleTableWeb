...
$l['view_task_logs_desc'] = "Quand une tâche est en cours d’exécution et que les suivis sont activés, tous les résultats ou erreurs seront affichés plus bas. Les entrées au-delà de 30 jours seront automatiquement supprimées.";
...
$l['time_minutes_desc'] = "Mettez une virgule pour séparer les listes (0-59) de minutes auxquelles cette tâche devra s’exécuter. Mettez ’*’ si cette tâche doit s’exécuter toutes les minutes.";
$l['time_hours'] = "Temps : Heures";
$l['time_hours_desc'] = "Mettez une virgule pour séparer les listes (0-23) d’heures auxquelles cette tâche devra s’exécuter. Mettez ’*’ si cette tâche doit s’exécuter toutes les heures.";
$l['time_days_of_month'] = "Temps : Jours du mois";
$l['time_days_of_month_desc'] = "Mettez une virgule pour séparer les jours du mois (1-31) durant lesquels cette tâche devra s’exécuter. Mettez ’*’ si cette tâche doit s’exécuter tous les jours, ou si vous spécifiez un jour dans la liste ci-dessous.";
...
$l['confirm_task_enable'] = "<strong>ATTENTION :</strong> Vous êtes sur le point d’activer une tâche qui est destinée à être activée via un planificateur (Rendez-vous sur <a href=\"https://docs.mybb.com/1.8/administration/task-manager\" target=\"_blank\">la documentation MyBB</a> pour plus d’informations en anglais). Continuer ?";
$l['no_tasks'] = "Il n’y a aucune tâche sur votre forum en ce moment.";
