...
$l['find_attachments'] = "Rechercher des PJ";
$l['find_attachments_desc'] = "Via le système de recherche de pièces jointes, vous pouvez chercher des fichiers spécifiques que les utilisateurs ont joint dans vos forums. Commencez par entrer quelques termes de recherche ci-dessous. Tous les champs sont optionnels et ne seront inclus que s’ils contiennent une valeur.";
$l['find_orphans'] = "Rechercher des PJ orphelines";
...
$l['attachment_stats'] = "Statistiques des PJ";
...
$l['error_not_all_removed'] = "Seules quelques pièces jointes orphelines ont été supprimées, les autres ne peuvent pas être supprimées du répertoire uploads.";
...
$l['error_does_not_exist'] = "Le sujet ou le message pour cette pièce jointe n’existe plus.";

// Success
$l['success_deleted'] = "Les pièces jointes sélectionnées ont été supprimées.";
$l['success_orphan_deleted'] = "La(les) pièce(s) jointe(s) orpheline(s) sélectionnée(s) a(ont) été supprimée(s).";
$l['success_count'] = '{1} pièce(s) jointe(s) supprimées.';
...
$l['stats_attachment_stats'] = "Pièces jointes - Statistiques des pièces jointes";
...
$l['reason_thread_deleted'] = "Le sujet a été supprimé.";
...
$l['poster_is'] = "Le posteur est";
$l['poster_is_either'] = "Utilisateur ou invité";
$l['poster_is_user'] = "Utilisateurs seulement";
$l['poster_is_guest'] = "Invités seulement";
$l['more_than'] = "Plus de";
...
$l['download_count'] = "Nb. de téléchargements";
...
// Buttons
$l['button_delete_orphans'] = "Supprimer les pièces jointes orphelines cochées";
