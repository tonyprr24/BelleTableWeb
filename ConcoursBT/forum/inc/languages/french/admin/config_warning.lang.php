...
$l['warning_types'] = "Types d’avertissement";
$l['warning_types_desc'] = "Ici vous pouvez gérer la liste des différents types d’avertissement que l’équipe est autorisée à délivrer à l’utilisateur.";
...
$l['warning_levels'] = "Niveaux d’avertissement";
$l['warning_levels_desc'] = "Les niveaux d’avertissement définissent ce qui se passe quand les utilisateurs ont atteint un niveau d’avertissement particulier (pourcentage du maximum de points d’avertissement). Vous pouvez bannir des utilisateurs ou suspendre leurs privilèges.";
...
$l['warning_points_percentage'] = "Pourcentage maximum de points d’avertissement";
...
$l['error_missing_action_type'] = "Sélectionnez une des mesures à prendre pour l’assigner à ce niveau d’avertissement.";
$l['error_missing_type_title'] = "Vous n’avez pas entré de titre pour ce type d’avertissement.";
$l['error_missing_type_points'] = "Vous n’avez pas entré un nombre de points correct à ajouter quand on délivre un avertissement de ce type. Vous devez entrer un nombre supérieur à 0 mais non supérieur à {1}.";
