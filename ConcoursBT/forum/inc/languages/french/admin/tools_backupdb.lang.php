...
$l['database_backups'] = "Sauvegardes de la base";
$l['database_backups_desc'] = "Ci-dessous sont listées les sauvegardes de la base de données actuellement stockées sur votre serveur dans le répertoire Backups de MyBB.";
...
$l['alert_not_writable'] = "Votre répertoire de sauvegarde (dans le répertoire administration) n’est pas accessible en écriture. Vous ne pouvez pas enregistrer les sauvegardes sur le serveur.";
