...
?>
    ...
    <div class="wrapper">
        <div class="header header-filter" style="background-image: url('assets/img/siegeBelleTable.jpg');">
            <div class="container">
                <div class="row">
					<div class="col-md-6">
						<h1 class="title">Belle Table</h1>
	                    <h4>BELLE TABLE, en plus de proposer un service complet de location de salles de réception incluant la livraison et l’installation des divers matériels,
		    	...
		    	<div class="section text-center section-landing">
	                <div class="row">
	                    <div class="col-md-8 col-md-offset-2">
	                        ...
	                        <h5 class="description">Voici où nous sommes implantés :</h5>
													test
	                    </div>
	                </div>
	            </div>
	        	...
	        	<div class="section text-center">
					...
					<div class="team">
						<div class="row">
			                ...
			                <div class="col-md-4">
			                    <div class="team-player">
			                        <img src="assets/img/elinole.png" alt="Thumbnail Image" class="img-raised img-circle">
			                        <h4 class="title">Elias Hamadouche<br />
										<small class="text-muted">Développeur FS</small>
									</h4>
			                        <p class="description">You can write here details about one of your team members. You can give more details about what they do. Feel free to add some <a href="#">links</a> for people to be able to follow them outside the site.</p>
									<a href="#pablo" class="btn btn-simple btn-just-icon"><i class="fa fa-twitter"></i></a>
									<a href="https://www.linkedin.com/in/elias-hamadouche-837266118/" class="btn btn-simple btn-just-icon"><i class="fa fa-linkedin"></i></a>
			                    </div>
			                </div>
			                <div class="col-md-4">
			                    <div class="team-player">
