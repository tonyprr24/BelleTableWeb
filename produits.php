...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>BelleTable &mdash; Produits</title>
  ...
  <!--
	...
	<body>
					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li><a class="active" href="produits.php">Produits</a></li>
			   		...
			   		<div class="container">
			   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
			   				<div class="slider-text-inner desc">
			   					<h2 class="heading-section">Nos Produits</h2>
			   					<p class="fh5co-lead">Explorer notre large gamme de produits</p>
			   				</div>
			   			</div>
			   		</div>
			   	</li>
		...
		<div id="fh5co-work-section">
			<center>
				<h2>Parcourir notre séléction</h2>
			</center>
			<br />
			<div class="container">
				<div class="row">
					<div class="col-md-4 text-center project">
						<a href="table.html" class="grid-project">
					...
					<div class="col-md-4 text-center project">
						<a href="couvert.html" class="grid-project">
					...
					<div class="col-md-4 text-center project">
						<a href="salle.html" class="grid-project">
